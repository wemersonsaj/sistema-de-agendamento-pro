                ...
                <main className="flex-1">
                    <div className="flex justify-between items-center mb-4">
                        ...
                        {['services', 'employees', 'appointments'].includes(activeTab) && (
                            <button onClick={() => handleOpenModal(activeTab as any, null)} className="flex items-center text-white font-bold py-2 px-4 rounded shadow" style={{ backgroundColor: settings.visuals.primaryColor }}>
